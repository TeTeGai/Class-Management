  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          body: BlocBuilder<NotificationBloc,NotificationState>(
            bloc:  NotificationBloc()..add(NotificationLoad()),
                              ...
                              itemBuilder: (context, index) {
                                return Dismissible(
                                  ...
                                  onDismissed: (direction) {
                                    NotificationBloc()..add(NotificationRemove(notificationModel[index].id));
                                  },
                                  ...
                                  child:    Padding(
                                    ...
                                    child: Container(
                                      child: InkWell(
                                          onTap: (){
                                            NotificationBloc()..add(NotificationUpdateModel(notificationModel[index].id));
                                          },
                                          child:  Container(
                                            decoration: BoxDecoration(
                                                                        ...
                                                                        children: [
                                                                          SizedBox(
                                                                            ...
                                                                            child: Column(
                                                                              ...
                                                                              children: [
                                                                                Text(
                                                                                  notificationModel[index].name +": "+ notificationModel[index].title  ,
                                                                                  style:
