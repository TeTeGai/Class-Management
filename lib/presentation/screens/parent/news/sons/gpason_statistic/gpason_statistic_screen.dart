...
class GpaSonStatisticScreen extends StatefulWidget {
  final StudentModel studentModel;
  const GpaSonStatisticScreen({Key? key, required this.studentModel,}) : super(key: key);

  @override
  State<GpaSonStatisticScreen> createState() => _GpaSonStatisticScreenState();
}

class _GpaSonStatisticScreenState extends State<GpaSonStatisticScreen>with AutomaticKeepAliveClientMixin<GpaSonStatisticScreen> {
  ...
  Widget build(BuildContext context) {
            return SingleChildScrollView(
              child:  Column(
                          children: [
                            GpaSonChartScreen(studentModel: widget.studentModel),
                            StreamBuilder(
                                      stream:  FirebaseFirestore.instance.collection("class").doc(widget.studentModel.classId).collection("gpaList").where("idStudent",isEqualTo: widget.studentModel.idStudent).snapshots(),
