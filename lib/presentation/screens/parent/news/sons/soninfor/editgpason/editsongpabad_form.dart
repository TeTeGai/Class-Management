...
class EditSonGpaBadForm extends StatefulWidget {

  const EditSonGpaBadForm({Key? key,}) : super(key: key);

  @override
  State<EditSonGpaBadForm> createState() => _EditSonGpaBadFormState();
}

class _EditSonGpaBadFormState extends State<EditSonGpaBadForm> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<ScoreBloc,ScoreState>(
        ...
        buildWhen: (previous, current) => current is GPABadSonLoaded,
                    ...
                    gpamodel.length>0 ? AnimationLimiter(
                      child: GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          if (index == 0)
                            {
                             return GPASonAddWidget(GoodOrBad: "Bad",);
                            }
