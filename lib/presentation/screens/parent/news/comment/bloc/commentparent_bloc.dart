...
class CommentBloc extends Bloc<CommentEvent,CommentState>
{
  ...
  async{
    ...
    try{
      ...
      _studentStreamSub = firebaseNewsRepository.LoadCmt(event.classId,event.posId).listen((event) => add(CommentUpdate(event)));
    }catch(e)
    {
  ...
  async{
    ...
    await firebaseNewsRepository.AddCmt(cmtModel, event.classId, event.postId);
  }
