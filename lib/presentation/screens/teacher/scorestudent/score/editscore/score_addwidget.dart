...
class ScoreAddWidget extends StatelessWidget {
  const ScoreAddWidget({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return  Padding(
        ...
        child: TextButton(
          onPressed: () {
            Navigator.of(context,rootNavigator: true).pushNamed(AppRouter.ADDSCORE);
          },
          child:  Container(
            width: 45.w,
            height: 12.h,
            ...
            child: Row(
              ...
              children: [
                ...
                ConstrainedBox(
                    ...
                    child: Text("Thêm mới",  maxLines: 2,
