...
class EditGpaGoodForm extends StatefulWidget {

  const EditGpaGoodForm({Key? key,}) : super(key: key);

  @override
  State<EditGpaGoodForm> createState() => _EditGpaGoodFormState();
}

class _EditGpaGoodFormState extends State<EditGpaGoodForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<ScoreBloc,ScoreState>(
        bloc: ScoreBloc()..add(GPAGoodLoad()),
                    ...
                    gpamodel.length>0 ? AnimationLimiter(
                      child: GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          if (index == 0)
                            {
                             return GPAAddWidget(GoodOrBad: "Good",);
                            }
