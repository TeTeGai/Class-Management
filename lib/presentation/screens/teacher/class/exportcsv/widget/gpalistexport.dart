...
class GpaListExport extends StatefulWidget {
  final String classId;
  const GpaListExport({Key? key, required this.classId}) : super(key: key);

  @override
  State<GpaListExport> createState() => _GpaListExportState();
}
List<List<String>> gpaList =[];
List<String> gpaListHeader =[];
class _GpaListExportState extends State<GpaListExport> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('class').doc(widget.classId).collection('gpaList').orderBy('timeCreate').snapshots(),
