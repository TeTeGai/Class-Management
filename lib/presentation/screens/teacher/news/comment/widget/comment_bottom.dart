...
class CommentBottom extends StatefulWidget {
  ...
  const CommentBottom({Key? key, required this.newModel, required this.pushToken}) : super(key: key);
...
class _CommentBottomState extends State<CommentBottom> {
  ...
  Future<void> onCmt(String avatar,String name) async {
    ...
    cmtBloc.add(
        CommentAdd(initModel, textEditingController.text , widget.newModel.id)
    );
